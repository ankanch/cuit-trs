...
def Mail(TO,TITLE,CONTENT):
  ...
  if type(TO) == type(["1","2"]):
    msg['To']=formataddr(["Subscriber",",".join(TO)])
  else:
...
#SendMail(["1075900121@qq.com","724350512@qq.com"],'测试群发邮件','括号中对应的是发件人邮箱账号、括号中对应的是发件人邮箱账号、收件人邮箱账号、发送邮件邮箱密码')
#SendMail("1075900121@qq.com",'测试单独邮件','括号中对应的是发件人邮箱账号、括号中对应的是发件人邮箱账号、收件人邮箱账号、发送邮件邮箱密码')
